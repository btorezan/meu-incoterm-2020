...
class IncotermsController {
  ...
  IncotermsController() {
    ...
    incoterms.add(Incoterm(
        ...
        {
          'TIPO DE TRANSPORTE':
              'O CIP pode ser usado com qualquer tipo de transporte (terrestre, marítimo, aéreo) e, principalmente, com transporte multimodal (conteineres).',
          'LOCAL DE ENTREGA E RECEBIMENTO DE MERCADORIA':
